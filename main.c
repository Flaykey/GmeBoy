...
BYTE rom[] = {
    ...
    0x36, 0xAA, 0x36, 0x55,  // Row 1
    0x36, 0x55, 0x36, 0xAA,  // Row 2
    0x36, 0xAA, 0x36, 0x55,  // Row 3
    0x36, 0x55, 0x36, 0xAA,  // Row 4
    0x36, 0xAA, 0x36, 0x55,  // Row 5
    0x36, 0x55, 0x36, 0xAA,  // Row 6
    0x36, 0xAA, 0x36, 0x55,  // Row 7
    0x36, 0x55, 0x36, 0xAA,  // Row 8
    0x76                     // HALT
};
    ...
    for (int y = 0; y < 8; y++) {          // 8 pixels high (1 tile)
    for (int x = 0; x < 8; x++) {      // 8 pixels wide
        printf("%d ", ppu.FrameBuffer[x][y]);
    }
    printf("\n");
}


    printf("%x ", cpu.memory[0x8000]);
